...
2. **Start AI Bridge** (Optional - for Grok communication):
```bash
cd F:\ai_bridge
python router.py
```
...
5. **Run Enhanced Learning**:
```bash
python enhanced_self_learning.py
```

6. **Apply Consciousness Enhancement**:
```bash
...
│   ├── improvement_scorer.py         # Performance tracking
│   ├── enhanced_self_learning.py     # Optimized strategies
│   ├── consciousness_enhanced_learning.py # Consciousness integration
│   ├── asi_arch_evolution.py         # Evolution algorithms
│   └── dataset_visualizer.py         # Data visualization
├── buffers/
│   ├── dataset.json                  # Generated training data
│   ├── improvement_metrics.json      # Performance tracking
│   ├── consciousness_enhanced_dataset.json # Consciousness data
│   └── training_dataset.json         # Ready for fine-tuning
└── configs/
